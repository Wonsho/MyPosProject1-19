...
public enum Item {
    ...
    HEX_BOLT_NORMAL("일반볼트", GroupCode.HEX_BOLT.groupCode, "A1", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"일반","A11","A8","A7"),
    HEX_BOLT_NORMAL_INCH("일반볼트 인치", GroupCode.HEX_BOLT.groupCode, "A2", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"일반","A85","A84","A83"),
    HEX_BOLT_STS("스텐볼트", GroupCode.HEX_BOLT.groupCode, "A3", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"스텐","A11","A8","A7"),
    HEX_BOLT_STS_INCH("스텐볼트 인치", GroupCode.HEX_BOLT.groupCode, "A4", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"스텐","A85","A84","A83"),
    HEX_BOLT_CM_KOREA("콜라볼트(국산)", GroupCode.HEX_BOLT.groupCode, "A5", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"콜라","A11","A8","A7"),
    HEX_BOLT_CM_KOREA_INCH("콜라볼트 인치(국산)", GroupCode.HEX_BOLT.groupCode, "A6", ItemDialogCode.QUANTITY_NUT_SW_PW, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean,"콜라","A85","A84","A83"),
    ...
    THREADED_BOLT("전산볼트", GroupCode.FULL_THREADED_BOLT.groupCode, "A28", ItemDialogCode.QUANTITY, ShowCode.MARTERIAL.korean, ShowCode.WIDTH.korean),
    THREADED_BOLT_INCH("전산볼트 인치", GroupCode.FULL_THREADED_BOLT.groupCode, "A29", ItemDialogCode.QUANTITY, ShowCode.MARTERIAL.korean, ShowCode.WIDTH.korean),
    ...
    CHAIN("체인", GroupCode.OTHER_THINGS.groupCode, "A44", ItemDialogCode.QUANTITY, ShowCode.MARTERIAL.korean, ShowCode.WIDTH.korean),
    ...
    WIRE("와이어", GroupCode.OTHER_THINGS.groupCode, "A48", ItemDialogCode.QUANTITY, ShowCode.MARTERIAL.korean, ShowCode.WIDTH.korean),
    ...
    FRENCH_BOLT_NORMAL("철-후렌지볼트", GroupCode.FRENCH_BOLT.groupCode, "A78", ItemDialogCode.QUANTITY, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean),
    FRENCH_BOLT_STS("STS후렌지볼트", GroupCode.FRENCH_BOLT.groupCode, "A79", ItemDialogCode.QUANTITY, ShowCode.WIDTH.korean, ShowCode.LENGTH.korean),
    ...
    Item(String koreanName, String groupCode, String itemCode, ItemDialogCode dialogCode, String verticalValue, String horizontalValue, String materialCode, String nutCode, String pwCode, String swCode) {
        this.groupCode = groupCode;
        this.koreanName = koreanName;
        this.itemCode = itemCode;
        this.dialogCode = dialogCode;
