...
public enum Group {
    ...
    HEX_BOLT("육각볼트","HEX"),
    WRENCH_BOLT("렌치볼트","LEN"),
    BUTTON_WRENCH_BOLT("둥근렌치","LNB"),
    PLAT_WRENCH_BOLT("접시렌치","LNP"),
    NOHEAD_WRENCH_BOLT("무두렌치","LNH");

    public final String groupCode;
    public final String koreanName;
    public final List<Item> itemList;

    Group(String koreanName, String groupCode) {
...
//    STEIN_SCREW("스텐피스류",GroupCode.STEIN_SCREW.groupCode),
//    U_BOLT("유볼트",GroupCode.U_BOLT.groupCode),
//    ANCHOR("앙카류",GroupCode.ANCHOR.groupCode),
